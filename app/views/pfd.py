...
def render(row: pd.Series, ctx: dict):
    ...
    _terminal(fig, 1.0, 8.8, "Washed<br>Bauxite",
              hover=f"Feed ~100 t kering<br>Al₂O₃ {row['al2o3_pct']:.1f}% · "
                    f"SiO₂ reaktif {sio2:.1f}%")
    ...
    st.caption(
        "PFD gambaran besar (bukan P&ID detail) · basis ~100 t bauksit kering · "
